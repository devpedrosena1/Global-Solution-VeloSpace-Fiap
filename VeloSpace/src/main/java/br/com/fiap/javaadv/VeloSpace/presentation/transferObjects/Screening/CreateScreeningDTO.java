...
public class CreateScreeningDTO {
    ...
    @NotNull(message = "A data de inspeção não pode ser nula")
    ...
    public static Screening toEntity(CreateScreeningDTO dto) {
        ...
        return Screening.builder()
                .payload(Payload.builder().payloadId(dto.getPayloadId()).build())
                .payloadHandler(PayloadHandler.builder().payloadHandlerId(dto.getPayloadHandlerId()).build())
                .measuredHeight(dto.getMeasuredHeight())
                .measuredWidth(dto.getMeasuredWidth())
                .measureLength(dto.getMeasureLength())
